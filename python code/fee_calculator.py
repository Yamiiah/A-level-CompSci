...
#med - parts replacement (brakes, bumpers), dent removal, remapping £20-200 30-120 min
...
easy = ['tyre change','oil change','liquid top-ups','remapping']
med = ['brake replacement','bumper replacement','small dent removal','small parts replacement']
hard = []
labour = 15
time = 0
